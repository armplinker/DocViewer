...
<telerik:RadAjaxManagerProxy runat="server" ID="UCDTCRM1_Proxy">
    <AjaxSettings>
        <telerik:AjaxSetting AjaxControlID="UCDTCRM1_Proxy">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="UCDTCRM1_Proxy"  />
            </UpdatedControls>
        </telerik:AjaxSetting>
...
<div>
    ...
    <asp:Panel runat="server" ID="RPBPanel1">
        <telerik:RadPanelBar ID="DTCRadPanelBar1" runat="server"
            ...
            OnItemClick="DTCRadPanelBar1_ItemClick"
            OnItemCreated="DTCRadPanelBar1_ItemCreated"
            OnItemDataBound="DTCRadPanelBar1_ItemDataBound"
            OnDataBinding="DTCRadPanelBar1_DataBinding"
            OnDataBound="DTCRadPanelBar1_DataBound"
            OnLoad="DTCRadPanelBar1_Load"
            OnUnload="DTCRadPanelBar1_Unload"
            OnDisposed="DTCRadPanelBar1_Disposed"
